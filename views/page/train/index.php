    ...
    <div class="container">
        <div class="col-10 col-md-8 mx-auto">
            ...
            <div class="card">
                ...
                <a href="<?php echo BASE_URL; ?>train/create" class="btn btn-sm btn-danger ms-2 mb-2 py-2 px-3">
                    Add New Voyage
                </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <form action="<?php echo BASE_URL; ?>train/edit" method="post" class="mr-1">
                                                    <input type="hidden" name="id_train" value="<?php echo $train->id_train;?>">
                                                    <button type="submit" class="btn btn-link btn-sm btn-rounded">
                                                        Edit
                                                    </button>
                                                </form>
                                                <form action="<?php echo BASE_URL; ?>train/delete" method="post" class="mr-1" onclick="return confirm('واش باغي تمحي هاذ الخرا ولا لا')">
                                                    <input type="hidden" name="id_train" value="<?php echo $train->id_train;?>"/>
                                                    <button type="submit" class="btn btn-link btn-sm btn-rounded">
                                                        Delete
                                                    </button>
